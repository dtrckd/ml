...
class Netw2(ExpDesign):
    ...
    compare_scvb = ExpTensor (
        ...
        _measures     = '_iteration time_it _entropy _entropy_t _K _alpha _gmma alpha_mean delta_mean alpha_var delta_var'
    )
    ...
    scvb = ExpTensor (
        ...
        _measures     = '_iteration time_it _entropy _entropy_t _K _chi_a _tau_a _kappa_a _chi_b _tau_b _kappa_b _elbo _roc'
    )
    ...
    scvb1_chi_a = ExpTensor (
        ...
        _measures     = '_iteration time_it _entropy _entropy_t _K _chi_a _tau_a _kappa_a _chi_b _tau_b _kappa_b'
    )
